...
#Ethernet adapter krijgt juiste naam en IP-adres.
...
#Het systeem krijgt de naam: WIN-SQL-3DE.
Write-Host("Server krijgt nieuwe naam: WIN-SQL-3DE")
Rename-Computer -NewName "WIN-SQL-3DE"
Start-Sleep -s 30
