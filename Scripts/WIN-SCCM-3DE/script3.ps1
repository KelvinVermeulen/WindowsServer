...
Write-host("ADK wordt geïnstalleerd en geconfigureerd.")
...
#WSUS feature wordt geiïnstalleerd. WSUS staat voor Windows Server Update Services en zorgt
#ervoor dat updates voor ieder systeem centraal beheerd en ingesteld en gepland kunnen worden.
Write-Host("WSUS feature wordt geïnstalleerd.")
